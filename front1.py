...
class gui1(ctk.CTk):
    def __init__(self):
        ...
        #showresult button
        self.sidebar_ShRst_button = ctk.CTkButton(self.logo_frame, text="Show Result", command=self.show_result, font=ctk.CTkFont('Arial', size=12))
        ...
        #reset button
        self.sidebar_Rst_button = ctk.CTkButton(self.logo_frame, text="Reset", command=self.reset, font=ctk.CTkFont('Arial', size=12))
        self.sidebar_Rst_button.grid(row=3, column=0, padx=20, pady=20)
        
        #exit button
        self.sidebar_Exit_button = ctk.CTkButton(self.logo_frame, text="Exit", command=self.exit, font=ctk.CTkFont('Arial', size=12))
    ...
    def show_result(self):
        ...
        second_gui.display_symptom_text(input)
        second_gui.mainloop()
    ...
    def configure_fonts(self):
        # Set font for About and Instruction labels
        about_font = ctk.CTkFont('Arial', size=20)
        instruction_font = ctk.CTkFont('Arial', size=20)

        # Configure fonts for the labels
        self.about.configure(font=about_font)
        self.instruction.configure(font=instruction_font)
    ...
    def calculate_button_width(self):
        ...
        base_button_width = 25  # Adjust this to your base button width
