...
from Rforest import prediction
#from symptom_data import get_prediction_result
...
class secondGUI(ctk.CTk):
    ...
    def display_symptom_text(self, text):
        ...
        #prediction_symp = get_prediction_result(prediction_result)
    
        # Insert the prediction result into the textbox
