...
class MLPModel:
    def __init__(self):
        self.model = MLPClassifier(hidden_layer_sizes=(200,150,117), activation='relu', solver='adam', alpha=0.5, learning_rate='adaptive', max_iter=80)
...
if __name__ == '__main__':
    ...
    # Model Training
    mlp_model = MLPModel()
    mlp_model.train_model(features_train, labels_train)
    ...
    predicted_conditions = mlp_model.model.classes_
    predicted_probabilities = mlp_model.model.predict_proba(user_input_transformed)[0]
