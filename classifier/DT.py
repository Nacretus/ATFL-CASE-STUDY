...
if __name__ == '__main__':
    ...
    # Model Training
    dt_model = DTModel()
    dt_model.train_model(features_train, labels_train)
    ...
    predicted_conditions = dt_model.model.classes_
    predicted_probabilities = dt_model.model.predict_proba(user_input_transformed)[0]
